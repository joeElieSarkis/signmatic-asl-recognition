...
# Paths
# =========================
SOURCE_PATH = Path(r"C:\Users\Joe\OneDrive\Desktop\signmatic_thesis\experiments\full_face_seq2seq\data")
OUTPUT_PATH = Path(r"C:\Users\Joe\OneDrive\Desktop\signmatic_thesis\experiments\full_face_seq2seq_normalized\data")
...
def process_split(split):
    x_path = SOURCE_PATH / f"X_{split}_face_full.npy"
    y_path = SOURCE_PATH / f"y_{split}_face_full.txt"
    clip_path = SOURCE_PATH / f"clip_names_{split}_face_full.txt"
    ...
    np.save(OUTPUT_PATH / f"X_{split}_face_full_norm.npy", X_norm)
    save_labels(OUTPUT_PATH / f"y_{split}_face_full_norm.txt", y)
    save_labels(OUTPUT_PATH / f"clip_names_{split}_face_full_norm.txt", clip_names)
...
if __name__ == "__main__":
    ...
    # copy vocab from full experiment
    src_vocab = SOURCE_PATH / "vocab_face_full.json"
    dst_vocab = OUTPUT_PATH / "vocab_face_full_norm.json"
    if src_vocab.exists():
