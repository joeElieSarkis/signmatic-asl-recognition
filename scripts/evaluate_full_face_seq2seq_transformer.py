...
MODEL_PATH = Path(r"C:\Users\Joe\OneDrive\Desktop\signmatic_thesis\experiments\full_face_seq2seq\models\best_full_face_seq2seq_transformer.pt")
OUTPUT_PATH = Path(r"C:\Users\Joe\OneDrive\Desktop\signmatic_thesis\experiments\full_face_seq2seq")
...
# Load test data
# =========================
X_test = np.load(BASE_PATH / "X_test_face_full.npy")
y_test = load_labels(BASE_PATH / "y_test_face_full.txt")
clip_names = load_labels(BASE_PATH / "clip_names_test_face_full.txt")
...
with torch.no_grad():
    for i in range(len(X_test)):
        ...
        # same input scaling as training
        x[:, :, 0::3] = x[:, :, 0::3] / 1000.0
        x[:, :, 1::3] = x[:, :, 1::3] / 1000.0
...
results_file = OUTPUT_PATH / "evaluation_results_full_face_seq2seq.txt"
