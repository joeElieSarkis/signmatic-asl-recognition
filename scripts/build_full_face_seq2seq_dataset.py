...
OUTPUT_PATH = Path(r"C:\Users\Joe\OneDrive\Desktop\signmatic_thesis\experiments\full_face_seq2seq\data")
...
def build_split(split):
    ...
    np.save(OUTPUT_PATH / f"X_{split}_face_full.npy", X)
    save_labels(OUTPUT_PATH / f"y_{split}_face_full.txt", y)
    save_labels(OUTPUT_PATH / f"clip_names_{split}_face_full.txt", clip_names)
