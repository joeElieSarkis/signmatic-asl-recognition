...
# Paths
# =========================
BASE_PATH = Path(r"C:\Users\Joe\OneDrive\Desktop\signmatic_thesis\experiments\top_phrases_classifier\data")
MODEL_PATH = Path(r"C:\Users\Joe\OneDrive\Desktop\signmatic_thesis\experiments\top_phrases_classifier\models\best_top_phrase_transformer_classifier.pt")
OUTPUT_PATH = Path(r"C:\Users\Joe\OneDrive\Desktop\signmatic_thesis\experiments\top_phrases_classifier")
...
X_test = np.load(BASE_PATH / "X_test_topphrases.npy")
y_test = np.load(BASE_PATH / "y_test_topphrases.npy")
y_text_test = load_lines(BASE_PATH / "y_text_test_topphrases.txt")
clip_names = load_lines(BASE_PATH / "clip_names_test_topphrases.txt")
...
results_file = OUTPUT_PATH / "evaluation_results_top_phrase_classifier.txt"
