...
MODEL_OUTPUT = Path(r"C:\Users\Joe\OneDrive\Desktop\signmatic_thesis\experiments\face_4words\models")
...
train_dataset = SignDataset(
    BASE_PATH / "X_train_face_4w.npy",
    BASE_PATH / "y_train_face_4w.txt",
    vocab
)

val_dataset = SignDataset(
    BASE_PATH / "X_val_face_4w.npy",
    BASE_PATH / "y_val_face_4w.txt",
    vocab
)
...
for epoch in range(EPOCHS):
    ...
    if val_loss < best_val_loss:
        ...
        epochs_without_improvement = 0
        torch.save(model.state_dict(), MODEL_OUTPUT / "best_face_4w_transformer.pt")
